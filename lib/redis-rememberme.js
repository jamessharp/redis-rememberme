...
(function() {
  var Cookie, RememberMe, connect, crypto, decodeRememberMeCookie, encodeRememberMeCookie, generateRandomToken, getRedisKeyVals, signature, winston;
  ...
  RememberMe = (function() {
    ...
    RememberMe.prototype.commenceCleanup = function() {
      this.cleanup();
      return this.cleanupId = setInterval(this.cleanup.bind(this), 24 * 3600 * 1000);
    };
    ...
    RememberMe.prototype.cleanup = function(callback) {
      ...
      return multi.exec(function(err, _arg) {
        var expiredObj, expiredObjs, key, objVal, removed, value, _i, _len;
